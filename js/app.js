...
let background_css3 = document.getElementById("background_css3");
...
window.addEventListener("load", () => {
    ...
    tl
        ...
        .to(background_css3, 0, {display: "unset"})
        .to(contactsSection, 0, {display: "flex"});

    background.initializr();

    $( window ).resize(function() {
        background_css3.innerHTML = "";
        background.initializr();
    });
...
background.initializr = function (){
    ...
    $this.style = {bubbles_color:"#272932",stroke_width:0, stroke_color :"black"};
    $this.bubbles_number = Math.round($(window).width() / 50);
    $this.speed = [5000,10000]; //milliseconds
